...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    const legacyCalculatorRedirects: Array<{
      ...
      { source: "/calculators/asset-017-personal-goal", destination: "/calculators", permanent: false },
      { source: "/calculators/goal-engineering-planner", destination: "/calculators", permanent: false },
      { source: "/goal-engineering-planner", destination: "/calculators", permanent: false },
