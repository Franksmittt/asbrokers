    ...
    <div className="bg-[#0a0a0c] min-h-screen">
      ...
      <section className="relative pt-28 pb-16 px-4 sm:px-6 md:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 max-w-4xl mx-auto relative overflow-hidden rounded-[2rem] border border-white/10 rim-light">
            <Image
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 pb-24">
        ...
        <div className="max-w-6xl mx-auto pb-10">
          <div className="flex justify-center">
            <div className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-white/10 rim-light aspect-square">
              <Image
