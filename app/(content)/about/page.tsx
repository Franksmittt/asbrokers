...
export const metadata = {
  title: "Independent Financial Advisor Krugersdorp | About AS Brokers CC",
  description:
    "AS Brokers CC is your independent financial advisor in Krugersdorp, East Rand. FSP 17273. Category 1.8. Albert Schuurman & Johnny Farinha. Retirement, insurance, estate planning since 1998.",
  openGraph: {
    title: "Independent Financial Advisor Krugersdorp | About AS Brokers CC",
    description: "Independent financial advisor Krugersdorp. FSP 17273. 25+ years. Retirement, Everest Wealth, estate.",
  },
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 w-full">
            <ImagePlaceholder
              ...
              alt="Independent financial advisor Krugersdorp"
              aspectRatio="16/9"
              placeholderLabel="about-visual.jpg"
            />
          </div>
        </div>
      </section>
