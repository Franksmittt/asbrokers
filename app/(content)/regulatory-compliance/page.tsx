...
export const metadata = {
  title: "Code 1.8 FSP License Broker | Regulatory Compliance | AS Brokers CC",
  description:
    "AS Brokers CC is a Code 1.8 FSP license broker authorised to distribute unlisted shares and Everest Wealth products. FSP 17273. FSCA Category 1.8 (Securities and Instruments: Shares).",
  openGraph: {
    title: "Code 1.8 FSP License Broker | AS Brokers CC",
    description: "Category 1.8 FSP broker. Unlisted shares, Everest Wealth. FSP 17273. FSCA authorised.",
  },
};
