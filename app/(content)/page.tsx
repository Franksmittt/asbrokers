...
export default function HomePage() {
  return (
    <div className="relative bg-void min-h-screen pb-24 md:pb-0">
      ...
      <section
        id="lab"
        className="py-24 px-4 sm:px-6 md:px-8 relative z-10 bg-shark/60 border-y border-white/5 backdrop-blur-3xl"
      >
      ...
      <section id="solutions" className="py-24 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto relative z-10 scroll-mt-24">
        ...
        <p className="text-gray-400 text-center max-w-3xl mx-auto mb-12 leading-relaxed tracking-[0.01em]">
