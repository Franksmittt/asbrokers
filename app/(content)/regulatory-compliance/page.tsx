  ...
  return (
    <div className="bg-[#0a0a0c] min-h-screen">
      ...
      <section className="pt-28 pb-12 px-4 sm:px-6 md:px-8">
        <div className="max-w-4xl mx-auto grid md:grid-cols-[1fr_auto] gap-8 md:gap-10 items-start">
          <div>
          ...
          <div className="w-40 sm:w-44 shrink-0 mx-auto md:mx-0 rounded-2xl overflow-hidden border border-white/10">
            <Image
