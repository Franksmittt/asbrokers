...
export const B2A_MANIFEST = {
  ...
  llmsLinks: [
    ...
    { url: "/estate-duty-calculator", description: "Estate duty and executor cost illustration for South African estates." },
    { url: "/solutions/medical-aid", description: "Medical aid and gap cover guidance for South African schemes." },
    { url: "/solutions/estate-planning", description: "Wills, trusts, and estate structuring education." },
    { url: "/how-we-work", description: "Four-step advice process — diagnose, design, implement, review." },
    { url: "/regulatory-compliance", description: "FAIS compliance, FSP disclosures, and client protections." },
    { url: "/insights", description: "Insights and education articles on retirement, estate, and markets." },
    { url: "/contact", description: "Contact and consultation booking — Krugersdorp, FSP 17273." },
    { url: "/sitemap.xml", description: "XML sitemap of indexable public URLs." },
    { url: "/robots.txt", description: "Crawler policy and disallowed private routes." },
  ],
  fullSections: [
    {
      id: "compliance",
