        ...
        <div className={`relative ${PAGE_CONTENT_MAX}`}>
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            <div className="lg:col-span-7">
              <p className="text-zinc-500 text-xs font-medium uppercase tracking-[0.2em] mb-3">AS Brokers</p>
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-10">
            ...
            <div className="text-zinc-400 text-sm leading-relaxed space-y-2">
              ...
              <p className="text-zinc-500">
                In client discussions we use them to explain: what the problem is, why it exists, and which product or
                structure solves it.
              </p>
            </div>
          </div>
      ...
      <section id="financial-education" className="py-16 border-t border-white/5 scroll-mt-24">
        <div className={PAGE_CONTENT_MAX}>
          ...
          <div className="w-full max-w-3xl mx-auto">
            ...
            >
              <span className="text-xs font-semibold text-cinematic-teal uppercase tracking-[0.15em]">
                Education & Growth
              </span>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-4">
                Most people leave their investments in the hands of others and accept whatever return they get. With the
                right education, you can learn to create and manage your own investments and earn a significantly higher
                return than the market delivers.
              </p>
              <span className="inline-flex items-center gap-1 text-cinematic-teal text-sm font-medium group-hover:gap-2 transition-all duration-300">
                Get in touch
              </span>
            ...
            <div className="lg:col-span-7">
              <div className="rounded-[2rem] border border-white/10 bg-[#101014] p-6 md:p-8">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-[2rem] bg-white px-6 py-3 font-bold text-black transition-all hover:bg-zinc-200"
                >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="rounded-[2rem] rim-light p-8 md:p-12 relative overflow-hidden">
              ...
              <div className="relative text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Stop Guessing Your Capital Lifespan.</h2>
                <Link
                  href="/contact"
                  prefetch={false}
