...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-6 right-6 w-14 h-14 bg-whatsapp-accessible text-white rounded-full items-center justify-center shadow-2xl hover:scale-110 transition-transform z-[45] group"
      data-visual-ignore
