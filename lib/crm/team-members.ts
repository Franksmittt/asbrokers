...
/** PIN-login CRM identities. PINs come from env (except Developer’s fixed pin). */
export type CrmTeamMemberKey = "albert" | "johnny" | "petro" | "developer";
...
export const CRM_TEAM_MEMBERS: Record<CrmTeamMemberKey, CrmTeamMember> = {
  albert: {
    ...
    role: "admin",
    pin: process.env.CRM_SUPERUSER_PIN?.trim() || "",
    canUseAi: true,
