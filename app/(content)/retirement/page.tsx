...
export default function RetirementPage() {
  return (
    <div className="bg-[#0a0a0c] min-h-screen">
      ...
      <section id="calculator" className="py-12 md:py-16 border-t border-white/5 bg-black/20 scroll-mt-24">
        <div className={PAGE_CONTENT_MAX}>
          <div className="rounded-[2rem] border border-red-500/20 shadow-[0_0_40px_rgba(239,68,68,0.12)] p-0 overflow-hidden">
