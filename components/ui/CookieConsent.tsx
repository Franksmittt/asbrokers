...
export function CookieConsent() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto flex min-w-0 flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <p className="min-w-0 text-sm text-zinc-300 leading-relaxed">
